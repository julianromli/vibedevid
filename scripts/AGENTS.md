...
**Schema Evolution**:
4. [`04_change_projects_id_to_sequential.sql`](04_change_projects_id_to_sequential.sql) - Legacy migration
5. [`05_add_foreign_key_constraints.sql`](05_add_foreign_key_constraints.sql) - Add referential integrity
6. [`06_enhance_views_table.sql`](06_enhance_views_table.sql) - Analytics enhancements
...
pnpm exec find scripts -name "*.sql" | sort
...
- [ ] Number it sequentially (e.g., `07_add_comments_table.sql`)
