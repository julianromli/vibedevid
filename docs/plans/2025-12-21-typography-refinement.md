...
export function Large({ className, ...props }: TypographyProps) {
  return (
    <div className={cn("text-fluid-lg text-foreground font-semibold", className)} {...props} />
  );
}
...
export function Small({ className, ...props }: TypographyProps) {
  return (
    <small
      className={cn("text-fluid-sm text-foreground leading-none font-medium", className)}
      {...props}
    />
  );
}
