  ...
  },
  {
    ...
    body: [
      <>
        ...
        <a href="mailto:support@vibedev.id" className="text-primary hover:underline">
          support@vibedev.id
        </a>
        .
      </>,
        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="border-border/70 mb-8 rounded-2xl border bg-gradient-to-b from-emerald-500/10 via-lime-500/5 to-transparent p-6 sm:p-8">
            ...
            <p className="text-muted-foreground text-sm sm:text-base">
              Halaman ini menjelaskan aturan penggunaan platform VibeDev ID agar komunitas tetap
              aman, terbuka, dan produktif.
            </p>
          ...
          <p className="text-muted-foreground mt-10 text-xs sm:text-sm">
            This document is for transparent platform governance and does not replace formal legal
            counsel.
          </p>
        </section>
      </main>
