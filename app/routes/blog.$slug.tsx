...
import { blogPostingSchema, breadcrumbListSchema } from '@/lib/seo/schema-templates'
...
export const Route = createFileRoute('/blog/$slug')({
  ...
  head: ({ loaderData }) => {
    ...
    const postTagsList = tags?.map((t) => t.post_tags?.name).filter((name): name is string => Boolean(name)) ?? []
