...
const sections = [
  ...
  },
  {
    ...
    body: [
      "Kami memproses data untuk menjalankan platform komunitas dengan aman, relevan, dan bermanfaat.",
    ],
    bullets: [
        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="border-border/70 mb-8 rounded-2xl border bg-gradient-to-b from-sky-500/10 via-cyan-500/5 to-transparent p-6 sm:p-8">
            ...
            <p className="text-muted-foreground text-sm sm:text-base">
              Halaman ini menjelaskan bagaimana VibeDev ID mengumpulkan, menggunakan, dan melindungi
          ...
          <p className="text-muted-foreground mt-10 text-xs sm:text-sm">
            This policy is provided for transparency and operational clarity for our community
            platform, and does not replace formal legal counsel.
          </p>
        </section>
      </main>
      <Footer />
