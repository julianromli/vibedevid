    ...
    <div className="bg-card border-border mb-6 rounded-xl border p-6 sm:p-8">
      <div className="flex flex-col gap-6 md:flex-row">
        <div className="flex flex-col items-center gap-4 md:items-start">
          ...
          />
          {isOwner && (
            <Button onClick={onEdit} variant="outline" size="sm" className="w-full md:w-auto">
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="mb-2">
            <h1 className="text-3xl font-bold leading-tight">
              <UserDisplayName name={displayName} role={user.role} />
            </h1>
          ...
          <div className="flex flex-wrap justify-center gap-3 md:justify-start">
            {socialLinks.map(({ label, href, Icon }) => (
              <Button key={label} variant="outline" size="icon" className="h-9 w-9" asChild>
                <a
                  href={href}
                  target="_blank"
