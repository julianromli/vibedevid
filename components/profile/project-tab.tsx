      ...
      {projects.map((project) => (
        <StaggerItem key={project.id}>
          <Link
            ...
            className="group flex h-full flex-col overflow-hidden rounded-xl border bg-card transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-1"
          >
