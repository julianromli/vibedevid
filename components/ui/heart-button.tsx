...
export function HeartButton({
  ...
  const buttonClasses = isPrimary
    ? `flex items-center px-4 py-2 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground transition-all duration-300 gap-2 hover:shadow-sm ${
        isAnimating ? "shadow-sm animate-heart-beat" : ""
      } ${!isLoggedIn ? "opacity-75" : ""} ${isLiked ? "bg-primary shadow-sm" : ""}`
    : `flex items-center px-3 py-1 rounded-full bg-muted/50 hover:bg-muted transition-all duration-300 gap-1 hover:shadow-sm ${
        isAnimating ? "shadow-sm" : ""
  ...
  const heartClasses = isPrimary
    ? `h-5 w-5 transition-all duration-300 ${
        isLiked ? "text-primary-foreground fill-primary-foreground animate-heart-pulse" : "text-primary-foreground"
