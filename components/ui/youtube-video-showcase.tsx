...
const YouTubeVideoShowcase = () => {
  ...
  if (loading) {
    return (
      <div className="w-full font-sans text-foreground">
        ...
        {/* Loading skeleton */}
        <div
          className="w-full max-w-5xl sm:max-w-6xl mx-auto min-w-[280px] sm:min-w-[300px] rounded-xl overflow-hidden px-2 sm:px-0"
  ...
  return (
    <div className="w-full font-sans text-foreground">
      ...
      <div
        className="videos-container flex w-full max-w-5xl sm:max-w-6xl mx-auto min-w-[280px] sm:min-w-[300px] overflow-hidden relative rounded-xl gap-1 px-2 sm:px-0"
        style={{ height: "auto", aspectRatio: "5/2" }}
      >
