                ...
                <div className="mx-auto w-full max-w-4xl">
                  ...
                  <div className="scrollbar-thin scrollbar-track-muted scrollbar-thumb-muted-foreground hover:scrollbar-thumb-foreground scrollbar-thumb-rounded-full scrollbar-track-rounded-full max-h-[60vh] overflow-y-auto p-4 pb-0">
                    <div className="space-y-6 text-sm">
                      <section>
                        <h3 className="mb-2 text-base font-semibold">1. Information We Collect</h3>
                        <p className="text-muted-foreground mb-2">
                          At VibeDev ID, we collect information you provide directly to us, such as when you create an
                          account, participate in community discussions, or contact us for support.
                        </p>
                      ...
                      <section>
                        <h3 className="mb-2 text-base font-semibold">2. How We Use Your Information</h3>
                        <p className="text-muted-foreground mb-2">
                      ...
                      <section>
                        <h3 className="mb-2 text-base font-semibold">3. Information Sharing</h3>
                        <p className="text-muted-foreground mb-2">
                      ...
                      <section>
                        <h3 className="mb-2 text-base font-semibold">4. Data Security</h3>
                      ...
                      <section>
                        <h3 className="mb-2 text-base font-semibold">5. Community Guidelines</h3>
                        <p className="text-muted-foreground">
                          As a member of VibeDev ID, you agree to maintain respectful interactions, share knowledge
                          constructively, and contribute to a positive learning environment for all developers in our
                          community.
                        </p>
                      </section>

                      <section>
                        <h3 className="mb-2 text-base font-semibold">6. Your Rights</h3>
                      ...
                      <section>
                        <h3 className="mb-2 text-base font-semibold">7. Contact Us</h3>
                        <p className="text-muted-foreground">
