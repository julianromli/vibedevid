    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Kirimkan event AI kamu untuk ditampilkan di platform. Event akan direview oleh admin
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="date" className="form-label-enhanced">
                Tanggal *
              </Label>
              <Input
                id="date"
            ...
            <div className="space-y-2">
              <Label htmlFor="time" className="form-label-enhanced">
                Waktu *
              </Label>
              <Input
                id="time"
          ...
          {/* Location Type */}
          <div className="space-y-2">
            <Label htmlFor="locationType" className="form-label-enhanced">
              Tipe Lokasi *
            </Label>
            <Select
          ...
          {/* Location Detail */}
          <div className="space-y-2">
            <Label htmlFor="locationDetail" className="form-label-enhanced">
              Detail Lokasi *
            </Label>
            <Input
              id="locationDetail"
            ...
            {errors.locationDetail && (
              <p className="text-red-500 text-sm">{errors.locationDetail}</p>
            )}
          </div>
          ...
          {/* Organizer */}
          <div className="space-y-2">
            <Label htmlFor="organizer" className="form-label-enhanced">
              Penyelenggara *
            </Label>
            <Input
              id="organizer"
          ...
          {/* Registration URL */}
          <div className="space-y-2">
            <Label htmlFor="registrationUrl" className="form-label-enhanced">
              URL Registrasi *
            </Label>
            <Input
              id="registrationUrl"
            ...
            {errors.registrationUrl && (
              <p className="text-red-500 text-sm">{errors.registrationUrl}</p>
            )}
          </div>
