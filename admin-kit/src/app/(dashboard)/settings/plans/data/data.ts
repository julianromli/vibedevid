...
const monthlyPlan = {
  ...
  additionalResources: ['Mentorship Program', 'Community Tutorials', 'Access to Knowledge Base'],
}
...
const annualPlan = {
  ...
  additionalResources: ['Mentorship Program', 'Community Tutorials', 'Access to Knowledge Base', 'Exclusive Workshops'],
}
