import { IconClipboardCheck, IconReceiptFilled, IconReportMoney, IconUserFilled } from '@tabler/icons-react'
...
export const recentActivityStatus = new Map<RecentActivityStatus, string>([
  ...
  ['Invited', ''],
  ['Suspended', 'bg-orange-50 border-orange-300 text-orange-700 dark:bg-orange-200 dark:text-orange-400'],
  ['New', 'bg-sky-100 border-sky-300 text-sky-700 dark:bg-sky-200 dark:text-sky-300'],
])
