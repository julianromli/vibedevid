...
import { type Icon, IconArrowNarrowRight, IconDots, IconProps } from '@tabler/icons-react'
...
export default function StatsCard({ label, icon: Icon, type, sign = 'number', stats, percentage, profit }: Props) {
  return (
    <Card className="h-full w-full">
      ...
      <CardContent className="space-y-[10px] px-4 pt-0 pb-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            {type === 'up' ? <ArrowUpRight size={16} /> : <ArrowDownRight size={16} />}
