...
export const getUsersByRoleFn = createServerFn({ method: "GET" }).handler(async () =>
  getUsersByRoleAction(),
);

export const getPostsByStatusFn = createServerFn({ method: "GET" }).handler(async () =>
  getPostsByStatusAction(),
);
